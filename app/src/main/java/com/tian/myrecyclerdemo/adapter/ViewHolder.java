...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public static ViewHolder get(Context context,View mConvertView,ViewGroup parent,int mLayoutId,int position){
        ...
        if(mConvertView == null){
            ...
            ViewHolder holder = (ViewHolder) mConvertView.getTag();
